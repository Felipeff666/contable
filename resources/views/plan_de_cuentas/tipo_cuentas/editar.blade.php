<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Editar tipo de cuenta') }}
        </h2>
        <a type="button"class=" pr-5 pl-5 mt-1 inline-flex bg-gray-700 hover:bg-gray-500 text-white rounded-full h-6 px-3 justify-center items-center" href="{{route('tipo_cuentas')}}">volver</a>
    </x-slot>
    ...
    <div class="mr-10 ml-10 mt-4 bg-gray-200 h-full">
        ...
        <div class="p-30">
            <form action="{{route('tipo_cuentas/editar/edit',$tipo_cuenta)}}" method="POST" >
                @csrf
                @method('put')
                <div class=" ml-20 mr-20 mt-3 mb-3 col-span-6 sm:col-span-3">
                    ...
                    @enderror
                    <input type="text" name="nombre" placeholder="nombre..." id="nombre" value="{{$tipo_cuenta->nombre}}"     
