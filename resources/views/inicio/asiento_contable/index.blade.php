<x-app-layout>
    ...
    <div class="flex justify-end ml-20 mr-20 pr-5">
        <a type="button"class=" pr-5 pl-5 mt-4  inline-flex bg-gray-700 hover:bg-gray-500 text-white rounded-full h-10  justify-center items-center" href="{{route('asiento_contable/pdf')}}">Generar PDF</a>
        <a type="button"class=" pr-5 pl-5 mt-4 ml-3 inline-flex bg-gray-700 hover:bg-gray-500 text-white rounded-full h-10  justify-center items-center" href="{{route('asiento_contable/insertar')}}">Registrar nuevo asiento contable</a>
    </div>
