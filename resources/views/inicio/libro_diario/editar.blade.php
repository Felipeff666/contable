<x-app-layout>
    ...
    <div class="mr-10 ml-10 mt-4 bg-gray-200 h-full">
        ...
        <div class="p-30">
            <form action="{{route('libro_diario/editar/edit', $libros_diarios)}}" method="POST" >
                @csrf
                @method('put')
                <div class=" ml-20 mr-20 mt-3 mb-3 col-span-6 sm:col-span-3">
                    ...
                    @enderror
                    <input type="text" name="nombre_denominacion" placeholder="numero..." id="nombre_denominacion"  value="{{$libros_diarios->nombre_denominacion}}"   
                ...
                <div class="ml-20 mr-20 mt-3 mb-3 col-span-6 sm:col-span-3">
                    ...
                    <x-alert>{{$message}}</x-alert>
                    @enderror
                    <input type="date" name="fecha_apertura" placeholder="" id="fecha_apertura" value="{{$libros_diarios->fecha_apertura}}"
                ...
                <div class="ml-20 mr-20 mt-3 mb-3 col-span-6 sm:col-span-3">
                    ...
                    <x-alert>{{$message}}</x-alert>
                    @enderror
                    <input type="date" name="fecha_cierre" placeholder="" id="fecha_cierre" value="{{$libros_diarios->fecha_cierre}}"
                        class="mt-1 text-gray-400 hover:text-gray-700 focus:border-gray-800 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                </div>
